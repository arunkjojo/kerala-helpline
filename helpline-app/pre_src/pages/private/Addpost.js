...
class Addpost extends React.Component{
    ...
    onSubmit=(e)=>{
        e.preventDefault();
        if((this.state.message==='') && (this.state.assets==='')){
            toastr.warning("What you need", "Inform to HELPERS!");
        }
        if(this.state.all==='' || this.state.police==='' || this.state.fire_force==='' || this.state.rapid_force==='' || this.state.medical==='' || this.state.gov_authority==='' || this.state.common_citizen===''){
            toastr.warning("Who can see your request?", "Who can see?");
        }
        if((this.state.message!=='' || this.state.assets!=='') && (this.state.all!=='' || this.state.police!=='' || this.state.fire_force!=='' || this.state.rapid_force!=='' || this.state.medical!=='' || this.state.gov_authority!=='' || this.state.common_citizen!=='')){
            this.uploadData();
        }
    }
    ...
    uploadData=()=>{
        ...
        formData.append('govAuthority',this.state.gov_authority)
            ...
            .catch(function (error) {
                // handle error
                toastr.warning("Your Information cannot be posted becouse,"+error, "Something error!");
                console.log(error);
            })
    }
