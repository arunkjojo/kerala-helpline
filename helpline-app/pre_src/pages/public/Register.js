            ...
            <div className="container">
                <form className="form-group" noValidate>
                    <div className="form-group">
                        ...
                        <Input type="text" autoComplete="off" autoFocus value={this.state.userName} onChange={this.inputSet} onKeyPress={this.validation} className="form-control" id="username" name="userName" placeholder="Enter your Name" required/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="mobile">Mobile Number</label>
                        <Input type="text" autoComplete="off" onKeyPress={(event) => { if (!/[0-9]/.test(event.key)) { event.preventDefault(); } }} onChange={this.inputSet} className="form-control" id="mobile" name="mobileNumber" placeholder="Enter your Mobile number" required noValidate/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <label htmlFor="localbody">Choose Area</label>
